...
const DesignGallery = ({ initialCategory }) => {
    ...
    return (
        <div className="page-container">
            <div className="relative h-[450px] flex items-center justify-center text-white text-center mb-10 overflow-hidden">
                {/* Background Image */}
                <div
                ...
                <div className="relative z-10 px-4 sm:px-6 lg:px-16 xl:px-20 py-8 w-full max-w-5xl">
                    <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-lg text-center">
                        Design <span className="text-teal-400">Gallery</span>
                    </h1>
                    <p className="text-lg md:text-xl opacity-90 leading-relaxed mx-auto max-w-3xl drop-shadow-md text-center">
                        {activeCategory === 'All' ? 'Explore our collection of 15,000+ home designs curated for every style and budget.' : `Explore our collection of ${activeCategory} designs tailored to your unique taste.`}
                    </p>
                </div>
            </div>
